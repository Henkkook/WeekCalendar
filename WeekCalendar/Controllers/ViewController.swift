...
class ViewController: UIViewController {
    ...
    private let prevWeekButton = MoveButton(imageName: "chevron.backward")
    private let nextWeekButton = MoveButton(imageName: "chevron.forward")
    ...
    private func updateData(day offset: Int) {
        ...
        prevMonthLabel.text = daysArray[7].monthName.changeWordEnding()
        nextMonthLabel.text = daysArray[13].monthName.changeWordEnding()
    }
}
